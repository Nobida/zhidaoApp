...
export default class Reading extends React.Component {
  ...
  handleQuoteClick(quoteType, item) {
    ...
    if (page_name.length) {
      history.push('/reading2-probation/'+lesson_id+'/'+page_name+'/'+QUOTE_DRAWER);
    } else {
  ...
  render() {
    ...
    return (
      <div className={"reading theme-"+reading_settings.theme}>
        ...
        />
        {
          cur_course.course && cur_course.course.ad_url && (
              <a className='ad-link' href={cur_course.course.ad_url}>
                  了解课程
              </a>
          )
        }
