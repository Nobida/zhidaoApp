...
export default class PageCardHeader extends React.Component {
  ...
  render(){
    ...
    const {cardName, lessonName, cardCount, curCardNum,cardBanner,dayNum,ifUnicom} = this.props;
      ...
      <div className='page-card-header-with-banner'>
        ...
        <div className='content'>
          <div className='lesson-info'>
            {ifUnicom?<span></span>:<span className='day'>{'DAY'+dayNum}</span>}
    ...
    const headerNormal = (
      <div className='page-card-header-normal'>
        ...
        <div className='info'>
          {ifUnicom?<div></div>:<div className='day'>{'DAY'+dayNum}</div>}
          <div className='line'/>
          <div className='progress'>
            {curCardNum+'/'+cardCount}
          </div>
