...
import { submitLessonRecord } from "../../actions/lesson_record";
import {
  fetchPublicLesson,
  fetchLessonBG,
  fetchLessonLecture,
...
import ReadingProbation from './ReadingProbation';
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ReadingProbation)
);
